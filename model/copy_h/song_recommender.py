...
loaded_model = load_model(r'MetaWave\vgg16_model.h5')
...
# 이미지첨부가되면...->
# 입력될 이미지의 경로입니다.
input_img_path = r'C:\Users\gjaischool\Desktop\MetaWave\MetaWave\test_img\cda25cac-5238-4380-b15e-84dcd07b1e06.png'
result = classify_image(input_img_path)
# 예측된 무드와 노래의 태깅
predic_theme = class_labels[result -1]

# 무작위 음악과 테마 재생
music_files_with_themes = get_music_files_with_themes(os.path.join(r'C:\Users\gjaischool\Desktop\jamendo', predic_theme))
